...
export default function ProductDetailPage() {
  ...
  useEffect(() => {
    ...
    // return will be executed when this component is unmount.
    // React won't run it immediately. It stores this return for later.
    return () => {
  ...
  return (
    <section
      onClick={handleClose}
      className="z-100 fixed inset-0 backdrop-blur-md flex justify-center items-center"
    >
      <main
      ...
      >
        ...
        {/* =================================================== */}
        <div className=" grid grid-cols-1 md:grid-cols-2 lg:grid-cols-1 lg:grid-rows-[auto_1fr] gap-4">
          {/* ------------------------ */}
          {/* Image */}
          {/* ------------------------ */}
        ...
        <div className="xl:col-span-2 flex flex-col gap-4 bg-background-secondary rounded-lg p-4 border-2 border-border">
          ...
          <div className="flex gap-4 border-b border-border py-2">
            ...
            <input
              type="text"
              value={!isEditing ? product?.category_name : newCategoryName!}
              readOnly={!isEditing}
          ...
          <div className="flex gap-4 border-b border-border py-2">
            ...
            <input
              type="text"
              value={!isEditing ? product?.description || "" : newDescription!}
              readOnly={!isEditing}
