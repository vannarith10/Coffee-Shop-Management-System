...
const ConfirmFinalize = ({ id }: { id: string }) => {
  ...
  if (isLoading || isFetching) {
    return (
      <div className="w-full h-full bg-background-secondary rounded-xl flex flex-col gap-6 justify-center items-center">
        ...
        <p className="font-semibold text-sm text-transparent shimmer shimmer-bg shimmer-color-background-secondary-hover border border-border">
          Confirm receipt of{" "}
        ...
        <button className="uppercase text-transparent shimmer shimmer-bg shimmer-color-background-secondary-hover border border-border py-10 px-20 text-xl font-bold rounded-lg cursor-pointer active:scale-80 outline-none transition-all duration-300 ease-out">
  ...
  if (isError) {
    return (
      <div className="w-full h-full bg-background-secondary rounded-xl flex flex-col gap-6 justify-center items-center">
        <button
          onClick={() => refetch()}
          className="bg-background-secondary-hover flex gap-2 items-center py-10 px-20 text-xl font-semibold rounded-lg cursor-pointer active:scale-80 outline-none transition-all duration-300 ease-out"
        >
          Try Again <RotateCw />
        </button>
      </div>
  ...
  return (
    <div className="w-full h-full bg-background-secondary rounded-xl flex flex-col gap-6 justify-center items-center">
      ...
      <button
        ...
        className="shimmer shimmer-bg shimmer-color-green-600 shimmer-duration-1500 uppercase bg-green-600/30 hover:bg-green-600/70 py-10 px-20 text-xl font-bold rounded-lg cursor-pointer active:scale-80 outline-none transition-all duration-300 ease-out"
      >
