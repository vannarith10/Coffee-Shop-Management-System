      ...
      {product?.products.map((p) => {
        ...
        return (
          ...
          >
            ...
            {/* Restock Button */}
            <button className="py-1 px-3 lg:px-6 bg-green-600 text-white font-bold rounded-sm justify-self-end cursor-pointer hover:scale-110 active:scale-90 focus:outline-none transition-all duration-300 ease-out">
              Restock
            </button>
          </div>
        );
