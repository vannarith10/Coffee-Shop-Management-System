...
export default function CategoryStatus() {
  ...
  // =======================================================
  function handleUpdateCategoryStatus (newCategoryStatus : CategoryStatusResponse) {
    setCategoryStatus(newCategoryStatus);
  }
  useCategoryStatusUpdate({onUpdateCategoryStatus: handleUpdateCategoryStatus});
          ...
          <div
            ...
            >
              <div className="flex justify-between">
                {/* Title & Icon*/}
                <h3 className="text-text-secondary w-full h-3 font-semibold text-sm bg-gray-400">
              ...
              {/* Description */}
              <p className="h-3 w-full bg-gray-400 text-text-secondary font-semibold">
        ...
        Array.from({ length: 4 }).map((_, i) => (
          <div
            ...
            >
              ...
              {/* Value */}
              <h2 className={`font-extrabold text-4xl text-text-error`}>
                Error
              </h2>
              {/* Description */}
        ...
        Object.entries(categoryStatus ?? {}).map(([key, value]) => {
          ...
          return (
            ...
            >
              ...
              {/* Value */}
              <h2 className={`font-extrabold text-4xl ${config.text_color}`}>
