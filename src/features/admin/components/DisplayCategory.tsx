          ...
          <main className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 p-1 gap-1">
            {category?.categories?.map((cat) => {
              ...
              return (
                <div
                  key={cat.category_id}
                  className={`flex flex-col gap-4 transition-all duration-300 ease-out ${isHighlighted ? "shimmer shimmer-bg shimmer-color-white/50 shimmer-duration-6000" : ""} ${disabled ? "bg-red-500/50" : "bg-background-secondary hover:bg-background-secondary-hover"} p-8 font-bold `}
                >
